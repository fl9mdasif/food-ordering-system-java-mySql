...
<body>
<div style ="color: white; text-align: center; font-size: 30px;">All products & Edit Products <i class='fas fa-cart-alert'></i></div>
<%
...
<%
        ...
        {
        %>
<h3 class = "alert">Product Successfully Remove!</h3>
<%}%>
<table>
<thead>
<%
